					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> congngheweb@gmail.com</a></li>
					...
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a target="_new" href=""><i class="fa fa-linkedin"></i></a></li>
								<li><a target="_new" href=""><i class="fa fa-dribbble"></i></a></li>
								<li><a target="_new" href=""><i class="fa fa-google-plus"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
